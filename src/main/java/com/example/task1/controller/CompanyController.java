...
public class CompanyController {
    ...
    @PostMapping
    public HttpEntity<ApiResponse> add(@RequestBody CompanyDTO address){
    ...
    public HttpEntity<List<Company>> getAll(){
        List<Company> addressServiceAll = addressService.getAll();
    ...
    @PutMapping("/{id}")
    public HttpEntity<ApiResponse> edited(@PathVariable int id , @RequestBody CompanyDTO addressDTO){
