...
public class WorkerController {
    @Autowired
    WorkerService addressService;

    @PostMapping
    public HttpEntity<ApiResponse> add(@RequestBody WorkerDTO address){
    ...
    public HttpEntity<List<Worker>> getAll(){
        List<Worker> addressServiceAll = addressService.getAll();
    ...
    @PutMapping("/{id}")
    public HttpEntity<ApiResponse> edited(@PathVariable int id , @RequestBody WorkerDTO addressDTO){
